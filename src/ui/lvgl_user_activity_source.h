...
// The one UserActivitySource implementation - lives here, not in
...
// simulator - both run LVGL, just different display drivers - so unlike
// most platform/ interfaces, there's no host/firmware split.
